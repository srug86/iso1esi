...
"adjuntos" de cada subarea. El adjunto se encargará de asignar la evaluación de sus
proyectos a los expertos más adecuados, y de, finalmente realizar los informes finales
de evaluación. El sistema lo usan los siguientes tipos de usuario:
...
%\imagen{DC.pdf}{}{Diagrama de Contexto}{}
%\imagen{DFD.0.pdf}{}{Diagrama de Sistemas}{}
%\imagen{DFD.1.pdf}{}{Gestión de Usuarios}{}
%\imagen{DFD.2.pdf}{}{Gestión de Paquetes Proyectos}{}
%\imagen{DFD.3.pdf}{}{Gestión de Evaluaciones}{}
%\imagen{DFD.3.1.pdf}{}{Gestión de Modelos}{}
%\imagen{DFD.3.2.pdf}{}{Gestión de Informes Evaluaciones}{}
%\imagen{DFD.4.pdf}{}{Gestión de Expertos}{}

\subsection{Definición de Flujo de Datos}
\input{DiccionarioISO}
...
%\image{ER.pdf}{}{Diagrama Entidad/Interrelación}{}
\subsection{Diagrama Relacional}
%\image{MRE.pdf}{}{Diagrama Relacional}{}

\section{Manual de usuario}
\subsection{Introducción}
\subsection{Perfiles de usuario}
\subsection{Interfaz de usuario}
%aquí se explica la interfaz donde todos los usuarios tiene que loguearse
...
\lstinputlisting{settings.php}
\subsubsection{login.css}
%\lstinputlisting{css/login.css}
\subsubsection{main.css}
%\lstinputlisting{css/main.css}
\subsubsection{users.php}
%\lstinputlisting{css/users.php}
\subsubsection{main.js}
\lstinputlisting{js/main.js}
\subsubsection{eval\_infs.php}
%\lstinputlisting{source/eval_infs.php}
\subsubsection{eval\_mods.php}
%\lstinputlisting{source/eval_mods.php}
\subsubsection{evaluations.php}
%\lstinputlisting{source/evaluations.php}
\subsubsection{loginout.php}
\lstinputlisting{source/loginout.php}
\subsubsection{mysql.php}
\lstinputlisting{source/mysql.php}
\subsubsection{login.php}
\lstinputlisting{theme/login.php}
\subsubsection{main.php}
\lstinputlisting{theme/main.php}
\subsubsection{users.php}
\lstinputlisting{theme/users.php}
