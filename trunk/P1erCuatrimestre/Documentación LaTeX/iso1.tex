...
% Encabezado y pie
\encabezado{Ingeniería del software I. Práctica 1: Desarrollo estructurado}
...
\subsubsection{Crear un modelo de evaluación}
\begin{enumerate}
...
\subsubsection{Modificar o eliminar un modelo de evaluación}
...
\subsubsection{Ver/Modificar informe final}
\begin{enumerate}
...
\subsubsection{Validar informe final}
...
\subsubsection{Realizar informe final}
\begin{enumerate}
\item Seleccionar el proyecto deseado de entre los disponibles (ver figura 
...
\subsection{Experto}
\subsubsection{Realizar evaluación de un proyecto}
\begin{enumerate}
