...
sistema a qué información tiene acceso cada usuario.
...
\item[Expertos] no tienen esta opción.
\end{description}
...
Se encarga de eliminar instancias de usuarios del sistema en el almacén de
...
Una vez que el usuario reciba el correo de alta, el siguiente paso es
...
momento para poder modificar cualquier cambio o error.
