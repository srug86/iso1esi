...
\imagen{Casos.png}{14}{Diagrama de casos de uso del sistema GDRPI}{dcasouso}
...
\imagen{SecIntPaq.png}{10}{Secretario
...
\imagen{CooValInf.png}{10}{Coordinador valida informe de
...
\imagen{AdjReaInf.png}{10}{Adjunto realiza informe de evaluación}
{AdjReaInf}
...
\imagen{ExpReaInf.png}{10}{Experto realiza informe de evaluación}
{ExpReaInf}
...
\begin{sidewaystable}
\imagen{Clases.png}{20}{Diagrama de clases del sistema GDRPI}{dclases}
\end{sidewaystable}
...
\item El adjunto puede ``Guardar'' o ``Finalizar informe'' 
  ...
  \imagen{opinf.pdf}{13}{\small{Guardar o finalizar informe final.}}{a6}
\end{enumerate}
...
\item Se guardan los cambios realizados en la evaluación con el botón 
  ...
  \imagen{saveend.pdf}{4}{\small{Guardar o finalizar evaluación.}}{img10}
\end{enumerate}
...
%\lstinputlisting[language=PHP]{implementacion/js/models.js}

\subsection{js/projects.js}
%\lstinputlisting[language=PHP]{implementacion/js/projects.js}

\subsection{js/reports.js}
%\lstinputlisting[language=PHP]{implementacion/js/reports.js}

\subsection{inc/area.php}
%\lstinputlisting[language=PHP]{implementacion/inc/area.php}

\subsection{inc/html.php}
%\lstinputlisting[language=PHP]{implementacion/inc/html.php}

\subsection{inc/loginout.php}
%\lstinputlisting[language=PHP]{implementacion/inc/loginout.php}

\subsection{inc/model.php}
%\lstinputlisting[language=PHP]{implementacion/inc/model.php}

\subsection{inc/modelmanager.php}
%\lstinputlisting[language=PHP]{implementacion/inc/modelmanager.php}

\subsection{inc/mysql.php}
%\lstinputlisting[language=PHP]{implementacion/inc/mysql.php}

\subsection{inc/package.php}
%\lstinputlisting[language=PHP]{implementacion/inc/package.php}

\subsection{inc/project.php}
%\lstinputlisting[language=PHP]{implementacion/inc/project.php}

\subsection{inc/projectmanager.php}
%\lstinputlisting[language=PHP]{implementacion/inc/projectmanager.php}

\subsection{inc/report.php}
%\lstinputlisting[language=PHP]{implementacion/inc/report.php}

\subsection{inc/reportmanager.php}
%\lstinputlisting[language=PHP]{implementacion/inc/reportmanager.php}

\subsection{inc/subarea.php}
%\lstinputlisting[language=PHP]{implementacion/inc/subarea.php}

\subsection{inc/user.php}
%\lstinputlisting[language=PHP]{implementacion/inc/user.php}

\subsection{inc/usermanager.php}
%\lstinputlisting[language=PHP]{implementacion/inc/usermanager.php}

\subsection{css/login.css}
%\lstinputlisting[language=PHP]{implementacion/css/login.css}

\subsection{css/main.css}
%\lstinputlisting[language=PHP]{implementacion/css/main.css}

\subsection{css/models.css}
%\lstinputlisting[language=PHP]{implementacion/css/models.css}

\subsection{css/reports.css}
%\lstinputlisting[language=PHP]{implementacion/css/reports.css}

\subsection{css/users.php}
%\lstinputlisting[language=PHP]{implementacion/css/users.php}
