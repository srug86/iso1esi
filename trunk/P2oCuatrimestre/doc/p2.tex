...
finales de la aplicación. Estas reuniones son fundamentales para poder
...
aspecto de la vida real, el trabajo en equipo. Una de las principales ventajas
del trabajo en grupo es la división del trabajo a realizar en
diferentes tareas, que se reparten entre los diferentes miembros del grupo y de
esta manera, se agilizan las etapas de desarrollo. Uno de los aspectos negativos
que conlleva el trabajo en grupo se muestra a la hora de tomar decisiones,
puesto que cada miembro tiene un punto de vista y en ocasiones es difícil
llegar a un acuerdo. 
...
Se desarrolla una aplicación para la gestión distribuida de la
...
distintos organismos (ministerios, universidades, empresas de investigación,
etc.). Existe un conjunto de áreas temáticas y cada área está compuesta por un
conjunto de subáreas. Cada área tiene un \emph{coordinador}, que se encarga de
asignar proyectos a cada uno de los \emph{adjuntos} de cada subárea. El
...
El sistema es utilizado por los siguientes tipos de usuario: 
\begin{itemize}
...
\item[Modelos de evaluación] Dependiendo de la información que contenga la
  convocatoria, elaborará unos modelos de informe de evaluación.  
