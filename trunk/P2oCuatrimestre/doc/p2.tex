...
\begin{sidewaystable}
\imagen{Clases.png}{16}{Diagrama de clases del sistema GDRPI}{dclases}
\end{sidewaystable}
...
%\imagen{}{13}{Vista de búsqueda de expertos del adjunto}{busexp}
\item Se puede rellenar cualquier campo para realizar la búsqueda y la
  aplicación da el resultado en forma de lista.
%\imagen{}{13}{Vista del resultado de la búsqueda de expertos}{resexp}
\end{itemize}
...
\item Se selecciona un determinado experto y se pulsa ``Valorar experto''. Se
  ...
  experto. 
%\imagen{}{13}{Vista de valoración de los expertos}{valexp}
\end{itemize}
...
%\lstinputlisting[language=PHP]{../GDRPI/inc/area.php}
...
%\lstinputlisting[language=PHP]{../GDRPI/inc/model.php}
