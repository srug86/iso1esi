...
\imagen{Entrada al sistema correcta.png}{10}{Entrada al sistema correcta}
{EntSisCor}
\imagen{Entrada al sistema erronea.png}{10}{Entrada al sistema errónea}
{EntSisErr}
...
\imagen{Secretario introduce un paquete de proyectos.png}{9}{Secretario
...
\imagen{Secretario crea un modelo de evaluacion.png}{10}{Secretario crea un
...
\imagen{Coordinador selecciona a un experto para ser adjunto de una subarea.png}
...
\imagen{Coordinador asigna un proyecto a una subarea.png}
...
\imagen{Coordinador valida informe.png}{9}{Coordinador valida informe de
...
\imagen{Adjunto busca expertos para evaluar proyecto.png}{9}
...
\imagen{Adjunto realiza informe.png}{9}{Adjunto realiza informe de evaluación}
{AdjReaInf}
...
\imagen{Experto realiza informe.png}{9}{Experto realiza informe de evaluación}
{ExpReaInf}
