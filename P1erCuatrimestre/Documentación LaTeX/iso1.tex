...
Con un diagrama de flujo de datos, se pueden visualizar la forma en que el 
sistema funcione, lo que el sistema va a lograr, y cómo el sistema se puede 
...
través de un diagrama de flujo de datos.
...
real. Se pretende \emph{visualizar} los objetos que pertenecen a la Base de 
