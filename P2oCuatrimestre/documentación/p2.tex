...
de usuario y la contraseña. Para autentificarse, el usuario rellenará estos
campos y aceptará. El sistema recogerá los datos y los comprobará con los
...
visualizar la interfaz correspondiente a su estatus dentro del sistema. En
...
Partimos de la base de que el secretario se ha autentificado en el sistema y
tiene acceso a la vista general del secretario.

La vista general del secretario accede al sistema para proporcionarle una
lista con los paquetes de proyectos introducidos en el sistema. En este caso
el secretario le da a introducir nuevo paquete y completa los campos
pertinentes que lo identificarán. Una vez completada la operación, el
...
selecciona el paquete de proyectos creado y selecciona la opción de
introducir nuevo proyecto. Uno a uno empieza a introducir los proyectos que
forman parte del paquete y el sistema los va almacenando.
...
Partimos de la base de que el coordinador se ha autentificado en el sistema y
tiene acceso a la vista general del adjunto.

La vista general del coordinador accede al sistema para proporcionarle una
lista con los proyectos asociados a su área. El coordinador selecciona uno
de los proyectos y selecciona la opción de ver o modificar el informe del
proyecto. El sistema carga el informe del proyecto realizada por el adjunto
...
Partimos de la base de que el adjunto se ha autentificado en el sistema y
tiene acceso a la vista general del adjunto.

La vista general del adjunto accede al sistema para proporcionarle una lista
...
búsqueda de expertos. Una vez introducidos, el adjunto envía la señal de
aceptar la búsqueda. El sistema utilizará los parámetros para iniciar una 
búsqueda con los expertos que tiene almacenados en la base de datos y
presentará una lista con los expertos que contienen las palabras clave. Por
último, el adjunto seleccionará los expertos que desea que evalúen el 
proyecto y aceptará la selección para que el sistema elabore una invitación
personalizada de evaluación para cada uno de estos expertos.

\subsection{Adjunto realiza informe}

\subsection{Experto realiza informe}
Partimos de la base de que el experto se ha autentificado en el sistema y
...
ellos. A continuación, el experto selecciona uno de los proyectos de la lista
y el sistema recupera la información asociada a este, así como de haberlo, el
informe realizado por el experto sobre el proyecto.

El experto redactará el informe conforme al modelo que este sigue y guardará
y finalizará su edición. El sistema almacenará dicho informe y cambiará su
estado a ``finalizado''.
...
ejemplos de clases de objetos reales, es sobre lo que un sistema se
